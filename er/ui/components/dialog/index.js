...
const buttonOk = tpl`<button class="primary rounded button" data-action="ok">${i18n('好的')}</button>`;
const buttonCancel = tpl`<button class="rounded button" data-action="cancel">${i18n('取消')}</button>`;
const buttonYes = tpl`<button class="primary rounded button" data-action="yes">${i18n('是')}</button>`;
const buttonNo = tpl`<button class="rounded button" data-action="no">${i18n('不')}</button>`;
